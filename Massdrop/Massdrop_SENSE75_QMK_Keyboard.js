...
const vKeyNames = [
	"Light 1", "Light 2", "Light 3", "Light 4", "Light 5", "Light 6", "Light 7", "Light 8", "Light 9", "Light 10", "Light 11", "Light 12", "Light 13", "Esc", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", "F12", "Print Screen", "Light 14", "Light 15", "~", "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "Backspace", "Del", "Light 16", "Light 17", "Tab", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "{", "}", "|", "Page Up", "Light 18", "Caps Lock", "A", "S", "D", "F", "G", "H", "J", "K", "L", ":", "\"", "Enter", "Page Down", "Light 19", "Left Shift", "Z", "X", "C", "V", "B", "N", "M", "<", ">", "?", "Right Shift", "Up Arrow", "Light 20", "Light 21", "Left Ctrl", "Left Win", "Left Alt", "Space", "Right Alt", "Fn", "Right Ctrl", "Left Arrow", "Down Arrow", "Right Arrow", "Light 22", "Light 23", "Light 24", "Light 25", "Light 26", "Light 27", "Light 28", "Light 29", "Light 30"
];
...
{
	return "https://raw.githubusercontent.com/SRGBmods/QMK-Images/main/images/Drop_Inc_SENSE75.png";
}
