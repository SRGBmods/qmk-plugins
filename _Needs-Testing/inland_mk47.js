export function Name() { return "Inland MK47 QMK Keyboard"; }
...
const vKeyNames = [
   "Esc", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "BackSpace", "Tab", "A", "S", "D", "F", "G", "H", "J", "K", "L", ":", "Enter", "Shift", "Z", "X", "C", "V", "B", "N", "M", "<", ">", "Up", "?", "Ctrl", "Win", "Alt", "Hyper", "Lower", "Space", "Ralse", "Fn", "Left", "Down", "Right"
];

const vKeyPositions = [
    [0, 0], [8, 0], [4, 0], [11, 0], [7, 0], [3, 0], [10, 0], [6, 0], [2, 0], [9, 0], [5, 0], [1, 0], [0, 3], [8, 3], [4, 3], [11, 3], [7, 3], [3, 3], [10, 3], [6, 3], [2, 3], [9, 3], [5, 3], [1, 3], [0, 1], [8, 1], [4, 1], [11, 1], [7, 1], [3, 1], [10, 1], [6, 1], [2, 1], [9, 1], [5, 1], [1, 1], [0, 2], [8, 2], [4, 2], [11, 2], [7, 2], [3, 2], [6, 2], [2, 2], [9, 2], [5, 2], [1, 2]
];
