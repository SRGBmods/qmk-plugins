export function Name() { return "Atlantis PS17 QMK Keyboard"; }
export function Version() { return "1.1.6"; }
export function VendorId() { return 0x0015; }
export function ProductId() { return 0x414B; }
export function Publisher() { return "Polyhaze (@Polyhaze) / Dylan Perks (@Perksey)"; }
export function Documentation(){ return "qmk/srgbmods-qmk-firmware"; }
export function Size() { return [13, 15]; }
...
const vKeyNames = [
	"Light 1", "Light 2", "Light 3", "Light 4", "Light 5", "Light 6", "Light 7", "Light 8", "Light 9", "Light 10", "Light 11", "Light 12", "Light 13", "Light 14", "Light 15", "Light 16", "Light 17", "Light 18", "Light 19", "Light 20", "Light 21", "Light 22", "Light 23", "Light 24", "Light 25", "Light 26", "Light 27", "Light 28"
];

const vKeyPositions = [
	[2, 3], [3, 3], [6, 3], [7, 3], [2, 1], [4, 1], [5, 1], [10, 0], [2, 14], [4, 14], [5, 14], [1, 12], [4, 12], [6, 12], [10, 6], [9, 9], [6, 9], [11, 10], [11, 11], [11, 13], [11, 4], [11, 5], [0, 5], [0, 2], [0, 13], [0, 7], [8, 10], [12, 8]
];
