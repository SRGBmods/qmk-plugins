export function Name() { return "Freya splaytoraid QMK Keyboard"; }
export function Version() { return "1.1.6"; }
export function VendorId() { return 0x2004; }
export function ProductId() { return 0xCB00; }
...
const vKeyNames = [
	"K02", "K10", "Light 1", "Light 2", "K50", "K42", "K62", "K61", "K33", "K73", "K64", "K63", "K43", "K55", "Light 3", "Light 4", "K15", "K03"
];

const vKeyPositions = [
	[0, 0], [7, 0], [9, 0], [2, 0], [4, 0], [1, 0], [0, 3], [1, 3], [7, 2], [9, 2], [2, 2], [4, 2], [9, 1], [6, 1], [3, 1], [8, 1], [5, 1], [2, 1]
];
