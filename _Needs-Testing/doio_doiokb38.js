export function Name() { return "Doio doio/kb38 QMK Keyboard"; }
export function Version() { return "1.1.6"; }
export function VendorId() { return 0xFEED; }
...
export function Size() { return [13, 8]; }
...
const vKeyNames = [
	"ESC", "BSPC", "RGB BACK", "RGB OFF", "RGB FORW", "MAKE", "REBOOT", "BOOTLOAD", "NUMLOCK", "PSLS", "PAST", "PMNS", "PAUS", "SCRL", "PSCR", "7", "8", "9", "PPLS", "INS", "HOME", "PGUP", "4", "5", "6", "END", "DEL", "PGDN", "1", "2", "3", "PENT", "UP", "0", "PDOT", "LEFT", "DOWN", "RIGHT", "Light 1", "Light 2", "Light 3", "Light 4", "Light 5", "Light 6"
];

const vKeyPositions = [
	[0, 0], [12, 0], [2, 0], [11, 0], [8, 0], [6, 0], [3, 0], [1, 0], [0, 4], [9, 4], [7, 4], [4, 4], [2, 4], [11, 4], [8, 4], [0, 6], [9, 6], [7, 6], [4, 1], [10, 6], [11, 6], [8, 6], [0, 3], [9, 3], [7, 3], [2, 3], [11, 3], [8, 3], [0, 5], [9, 5], [7, 5], [4, 7], [11, 5], [5, 2], [7, 2], [2, 2], [11, 2], [8, 2], [1, 2], [4, 2], [0, 2], [0, 0], [4, 0], [1, 0]
];
