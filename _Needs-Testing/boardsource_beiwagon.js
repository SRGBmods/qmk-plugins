export function Name() { return "Boardsource Beiwagon QMK Keyboard"; }
export function Version() { return "1.1.5"; }
export function VendorId() { return 0x4273; }
export function ProductId() { return 0x0066; }
...
const vKeyNames = [
   "Light 1", "Light 2", "Light 3", "Light 4", "Light 5", "Light 6", "Light 7", "Light 8", "Light 9", "Light 10", "Light 11", "Light 12", "Light 13", "Light 14", "Light 15", "Light 16", "Light 17", "Light 18"
];

const vKeyPositions = [
    [3, 2], [3, 4], [3, 6], [4, 2], [4, 4], [4, 6], [0, 0], [1, 0], [2, 0], [0, 3], [1, 3], [2, 3], [0, 5], [1, 5], [2, 5], [0, 1], [1, 1], [2, 1]
];
