export function Name() { return "1upkeyboards sweet16v2 QMK Keyboard"; }
export function Version() { return "1.1.6"; }
export function VendorId() { return 0x6F75; }
export function ProductId() { return 0x5518; }
...
const vKeyNames = [
   "Light 1", "Light 2", "Light 3", "Light 4", "Light 5", "Light 6", "Light 7", "Light 8", "Light 9", "Light 10", "Light 11", "Light 12", "Light 13", "Light 14", "Light 15", "Light 16", "Light 17", "Light 18", "Light 19", "Light 20"
];

const vKeyPositions = [
    [2, 0], [3, 0], [0, 0], [1, 0], [1, 4], [1, 5], [0, 5], [3, 5], [2, 4], [2, 5], [2, 1], [3, 1], [0, 1], [1, 1], [1, 3], [1, 2], [0, 2], [3, 2], [2, 3], [2, 2]
];
