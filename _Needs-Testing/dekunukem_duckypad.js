export function Name() { return "dekuNukem duckyPad QMK Keyboard"; }
export function Version() { return "1.1.6"; }
export function VendorId() { return 0x444E; }
export function ProductId() { return 0x4450; }
...
const vKeyNames = [
   "Light 1", "Light 2", "Light 3", "Light 4", "Light 5", "Light 6", "Light 7", "Light 8", "Light 9", "Light 10", "Light 11", "Light 12", "Light 13", "Light 14", "Light 15"
];

const vKeyPositions = [
    [1, 0], [2, 0], [0, 0], [0, 3], [2, 3], [1, 3], [1, 1], [2, 1], [0, 1], [0, 4], [2, 4], [1, 4], [1, 2], [2, 2], [0, 2]
];
