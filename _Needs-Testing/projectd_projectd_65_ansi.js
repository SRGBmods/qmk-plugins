export function Name() { return "ProjectD ProjectD 65% ANSI QMK Keyboard"; }
export function Version() { return "1.1.6"; }
export function VendorId() { return 0x3233; }
export function ProductId() { return 0x5319; }
export function Publisher() { return "Polyhaze (@Polyhaze) / Dylan Perks (@Perksey)"; }
export function Documentation(){ return "qmk/srgbmods-qmk-firmware"; }
export function Size() { return [55, 5]; }
...
const vKeyNames = [
	"Esc", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=", "Backspace", "Del", "Tab", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "[", "]", "\\", "PGUP", "Caps Lock", "A", "S", "D", "F", "G", "H", "J", "K", "L", ";", "'", "Enter", "PGDN", "LShift", "Z", "X", "C", "V", "B", "N", "M", ",", ".", "/", "RShift", "Up", "End", "LCtrl", "LWin", "LAlt", "Light 1", "Light 2", "Space", "Light 3", "Light 4", "RAlt", "FN", "Left", "Down", "Right"
];

const vKeyPositions = [
	[0, 0], [3, 0], [8, 0], [13, 0], [17, 0], [21, 0], [25, 0], [31, 0], [35, 0], [39, 0], [43, 0], [47, 0], [51, 0], [1, 0], [10, 0], [0, 2], [6, 2], [11, 2], [15, 2], [19, 2], [23, 2], [28, 2], [33, 2], [37, 2], [41, 2], [45, 2], [49, 2], [53, 2], [2, 2], [10, 2], [0, 3], [7, 3], [12, 3], [16, 3], [20, 3], [24, 3], [29, 3], [34, 3], [38, 3], [42, 3], [46, 3], [50, 3], [54, 3], [10, 3], [0, 4], [9, 4], [14, 4], [18, 4], [22, 4], [27, 4], [32, 4], [36, 4], [40, 4], [44, 4], [48, 4], [52, 4], [5, 4], [10, 4], [0, 1], [4, 1], [11, 1], [26, 1], [27, 1], [28, 1], [29, 1], [30, 1], [43, 1], [48, 1], [1, 1], [5, 1], [10, 1]
];
