export function Name() { return "tominabox1 Le Chiffre QMK Keyboard"; }
export function Version() { return "1.1.6"; }
export function VendorId() { return 0x7431; }
export function ProductId() { return 0xD645; }
...
const vKeyNames = [
	"Light 1", "Light 2", "Light 3", "Light 4", "Light 5", "Light 6", "Light 7", "Light 8", "Light 9", "Light 10", "Light 11"
];

const vKeyPositions = [
	[1, 1], [3, 1], [0, 3], [0, 0], [5, 0], [2, 0], [6, 0], [6, 3], [4, 1], [1, 2], [1, 4]
];
