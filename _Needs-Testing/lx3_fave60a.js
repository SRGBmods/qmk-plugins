export function Name() { return "Lx3 fave60a QMK Keyboard"; }
...
const vKeyNames = [
	"Ctrl", "Fn", "Alt", "K58", "Alt", "Win", "Ctrl", "Shift", "Z", "X", "C", "V", "B", "N", "M", "<", ">", "?", "Shift", "Enter", "\"", ":", "L", "K", "J", "H", "G", "F", "D", "S", "A", "Caps Lock", "Tab", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "{", "}", "|", "Bksp", "+", "_", ")", "(", "*", "&", "^", "%", "$", "#", "@", "!", "Esc", "Light 1", "Light 2", "Light 3", "Light 4", "Light 5", "Light 6", "Light 7", "Light 8", "Light 9", "Light 10", "Light 11", "Light 12", "Light 13", "Light 14", "Light 15", "Light 16", "Light 17", "Light 18", "Light 19", "Light 20", "Light 21", "Light 22", "Light 23", "Light 24", "Light 25", "Light 26", "Light 27", "Light 28", "Light 29", "Light 30", "Light 31"
];

const vKeyPositions = [
	[14, 2], [6, 2], [13, 2], [3, 2], [1, 2], [8, 2], [0, 2], [0, 6], [1, 6], [9, 6], [2, 6], [10, 6], [3, 6], [11, 6], [4, 6], [12, 6], [5, 6], [13, 6], [14, 6], [14, 1], [13, 1], [5, 1], [12, 1], [4, 1], [11, 1], [3, 1], [10, 1], [2, 1], [9, 1], [15, 1], [7, 1], [0, 1], [0, 5], [8, 5], [1, 5], [9, 5], [2, 5], [10, 5], [3, 5], [11, 5], [4, 5], [12, 5], [5, 5], [13, 5], [6, 5], [14, 5], [14, 0], [6, 0], [13, 0], [5, 0], [12, 0], [4, 0], [11, 0], [3, 0], [10, 0], [2, 0], [9, 0], [1, 0], [8, 0], [0, 0], [0, 3], [8, 3], [1, 3], [9, 3], [2, 3], [10, 3], [3, 3], [11, 3], [4, 3], [12, 3], [5, 3], [13, 3], [6, 3], [14, 3], [14, 7], [14, 4], [14, 8], [13, 8], [5, 8], [12, 8], [4, 8], [11, 8], [3, 8], [10, 8], [2, 8], [9, 8], [1, 8], [8, 8], [0, 8], [0, 4], [0, 7]
];
