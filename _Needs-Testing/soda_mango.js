export function Name() { return "Soda Mango QMK Keyboard"; }
export function Version() { return "1.1.6"; }
export function VendorId() { return 0x3A54; }
export function ProductId() { return 0x4F5D; }
...
const vKeyNames = [
	"Num Lock", "/", "*", "-", "7", "8", "9", "4", "5", "6", "Light 1", "1", "2", "3", "0", "Light 2", "."
];

const vKeyPositions = [
	[0, 0], [3, 0], [4, 0], [1, 0], [0, 3], [3, 3], [4, 3], [0, 1], [3, 1], [4, 1], [1, 5], [0, 4], [3, 4], [4, 4], [2, 2], [4, 2], [1, 2]
];
