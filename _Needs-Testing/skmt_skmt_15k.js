export function Name() { return "SKMT SKMT 15k QMK Keyboard"; }
export function Version() { return "1.1.6"; }
export function VendorId() { return 0xFEFE; }
export function ProductId() { return 0x3488; }
...
const vKeyPositions = [
	[1, 2], [2, 2], [3, 2], [4, 2], [0, 2], [1, 1], [2, 1], [3, 1], [4, 1], [0, 1], [1, 0], [2, 0], [3, 0], [4, 0], [0, 0]
];
