export function Name() { return "gkeyboard GPAD8-2R QMK Keyboard"; }
export function Version() { return "1.1.6"; }
export function VendorId() { return 0x474B; }
export function ProductId() { return 0x4202; }
...
const vKeyPositions = [
    [2, 0], [3, 0], [0, 0], [1, 0], [2, 1], [3, 1], [0, 1], [1, 1], [2, 2], [3, 2], [0, 2], [1, 2], [2, 3], [3, 3], [0, 3], [1, 3]
];
