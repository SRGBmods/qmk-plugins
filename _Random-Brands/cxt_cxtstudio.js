export function Name() { return "CXT cxt_studio QMK Keyboard"; }
export function Version() { return "1.1.6"; }
export function VendorId() { return 0x5754; }
export function ProductId() { return 0xC401; }
...
const vKeyNames = [
   "Light 1", "Light 2", "Light 3", "Light 4", "Light 5", "Light 6", "Light 7", "Light 8", "Light 9", "Light 10", "Light 11", "Light 12"
];

const vKeyPositions = [
    [3, 0], [2, 0], [1, 0], [0, 0], [0, 1], [1, 1], [2, 1], [3, 1], [3, 2], [2, 2], [1, 2], [0, 2]
];
